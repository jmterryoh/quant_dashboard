...
def main():
    ...
    with st.container():
        ...
        print(price_high_df, i10dt_string_datetime, i10dt_end_string_datetime)
        ...
        i10dt_start_string_datetime = pytz.timezone('Asia/Seoul').localize(datetime.strptime(i10dt, "%Y%m%d")).strftime("%Y-%m-%d 23:59:59")
        if i10dt == idt:
        ...
        idt_string_datetime = pytz.timezone('Asia/Seoul').localize(datetime.strptime(vdt, "%Y%m%d")).strftime("%Y-%m-%d")
        ...
        if previous_vdt:
            previous_vdt_string_datetime = pytz.timezone('Asia/Seoul').localize(datetime.strptime(previous_vdt, "%Y%m%d")).strftime("%Y-%m-%d")
